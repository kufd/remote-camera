...
#define OV7670_RST_PORT		CAMERA_RESET_GPIO_Port
#define OV7670_RST_PIN		CAMERA_RESET_Pin
#define OV7670_PWDN_PORT	CAMERA_POWER_DOWN_GPIO_Port
#define OV7670_PWDN_PIN		CAMERA_POWER_DOWN_Pin
